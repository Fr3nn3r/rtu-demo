...
const accidentSteps: StepDefinition[] = [
  ...
  },
  {
    ...
    isBridgeStep: true,
    bridgeSystem: 'nimbis',
    description: 'Look up the policy on Nimbis. Enter the policy number and excess amount, then confirm validity.',
  },
  {
    state: 'REGISTERED',
    label: 'Registered',
    ...
    isBridgeStep: true,
    bridgeSystem: 'roc',
    description: 'Register the claim on ROC. Enter the SPM claim number and confirm registration.',
  },
  {
    ...
    isBridgeStep: true,
    bridgeSystem: 'roc',
    description: 'Select an assessor from the list and confirm appointment on ROC.',
  ...
  },
  {
    ...
    isBridgeStep: true,
    bridgeSystem: 'roc',
    description: 'Appoint QA on ROC. Await QA decision.',
  },
  {
    state: 'QA_DECISION',
    label: 'QA Decision',
  ...
  },
  {
    ...
    isBridgeStep: true,
    bridgeSystem: 'roc',
    description: 'Confirm that the Authority of Loss has been generated on ROC.',
  },
  {
    state: 'ROUTE_TYPE',
...
const theftSteps: StepDefinition[] = [
  ...
  },
  {
    ...
    isBridgeStep: true,
    bridgeSystem: 'nimbis',
    description: 'Look up the policy on Nimbis. Enter the policy number, then confirm validity.',
  },
  {
    state: 'REGISTERED',
    label: 'Registered',
  ...
  },
  {
    ...
    isBridgeStep: true,
    bridgeSystem: 'roc',
    description: 'Select an investigator from the list and confirm appointment on ROC.',
